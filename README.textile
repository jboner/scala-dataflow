...
Implements "Oz-style":http://en.wikipedia.org/wiki/Oz_(programming_language "dataflow concurrency":http://www.mozart-oz.org/documentation/tutorial/node8.html#chapter.concurrency through dataflow (single assignment) variables and streams as well as lightweight (event-based) processes/threads. 
