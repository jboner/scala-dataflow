...
Implements "Oz-style":http://en.wikipedia.org/wiki/Oz_(programming_language dataflow (single assignment) variables and streams as well as lightweight (event-based) processes/threads. 
